package es.nom.marcosfernandez.stocks.services;

import es.nom.marcosfernandez.stocks.model.Image;
...
/**
 * Service only for LEARNING, not real business logic application
 */
@Service
public class ImageService {
    ...
    {
        this.resouceLoader = resourceLoader;
    }
    ...
    public Mono<Resource> findOneImage(String filename) {
        return Mono.fromSupplier(() -> resouceLoader.getResource("file:" + UPLOAD_ROOT + "/" + filename));}
